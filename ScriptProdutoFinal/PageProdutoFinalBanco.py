...
if pagina == "Apresentação":
    ...
    st.image("https://raw.githubusercontent.com/jefferson-datascience/PrevisaoAceitarContratoBanco/blob/main/ScriptProdutoFinal/LogoMarketing1.jpg", width='stretch')
